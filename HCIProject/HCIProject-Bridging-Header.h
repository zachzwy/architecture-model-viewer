 ...
 */
@interface GTMAppAuthExampleViewController : UIViewController <UITextViewDelegate>

@property(nullable) IBOutlet UIButton *authAutoButton;
@property(nullable) IBOutlet UIButton *userinfoButton;
@property(nullable) IBOutlet UIButton *driveAPIButton;
...
/*! @brief Performs a Drive API call.
 @param sender IBAction sender.
 */
- (IBAction)fetchFileList:(nullable id)sender;
